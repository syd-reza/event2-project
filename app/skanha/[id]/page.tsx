...
export default function SkanhaDetailPage() {
  ...
  return (
    <div className="container mt-8">
      <div
        className={`py-4 mb-4 text-center rounded-2xl ${
          person.zarfirat === "خالی"
            ? "bg-green-100 text-green-800"
            : person.zarfirat === "درحال پرشدن"
            ? "bg-yellow-100 text-yellow-800"
            : person.zarfirat === "پرشده" || person.zarfirat === "پر"
            ? "bg-red-100 text-red-800"
            : person.zarfirat === "شلوغی بیش از حد"
            ? "bg-red-200 text-red-900"
            : "bg-gray-100 text-gray-800"
        }`}
      >
        <h2 className="font-bold">ظرفیت این اسکان {person.zarfirat} است</h2>
      </div>
